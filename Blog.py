...
c = conn.cursor()
st.set_page_config(page_title='Tensor Data Platform',  layout='wide')
# Functions
def create_table():
...
if choice == "Home":
	...
	components.iframe("https://share.streamlit.io/andyism1014/streamlit-example/TensorDataPlatform.py",height=10000)